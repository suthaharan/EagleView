...
const App: React.FC = () => {
  ...
  // Fix: Add dailyNotification to initial state to satisfy UserPreferences type requirement
  ...
  const loadUserData = (userId: string) => {
    ...
    // Fix: Add dailyNotification to default fallback object to satisfy UserPreferences type requirement
